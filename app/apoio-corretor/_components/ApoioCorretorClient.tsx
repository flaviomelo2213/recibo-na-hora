...
export default function ApoioCorretorClient() {
      ...
      <div className="container mx-auto px-4 py-12 md:py-16 max-w-6xl">
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-slate-900 mb-6">
            Perguntas Frequentes do Corretor
          </h2>
          <div className="space-y-4">
            <details className="bg-white border border-slate-200 rounded-xl p-5 group">
              ...
              <p className="mt-3 text-sm text-slate-600">
                Depende do município e do regime tributário. Corretores autônomos (pessoa física) geralmente emitem <strong>Recibo de Pagamento de Autônomo (RPA)</strong>. Corretores com CNPJ emitem nota fiscal de serviços (ISS). Verifique a legislação do seu município.
              </p>
            </details>

            <details className="bg-white border border-slate-200 rounded-xl p-5 group">
              <summary className="font-semibold text-slate-900 cursor-pointer list-none flex justify-between items-center">
                Qual contrato usar para intermediação imobiliária?
                <span className="text-slate-400 group-open:rotate-180 transition-transform">&#9660;</span>
              </summary>
              <p className="mt-3 text-sm text-slate-600">
                Use um <strong>contrato de prestação de serviços de corretagem</strong> com valor da comissão, prazo de exclusividade e obrigações das partes. Para locação, o contrato deve seguir a Lei 8.245/91 (Lei do Inquílinato). <Link href="/contratos" className="text-blue-700 hover:underline">Acesse nossos modelos de contrato →</Link>
              </p>
            </details>
            ...
            <details className="bg-white border border-slate-200 rounded-xl p-5 group">
              ...
              <p className="mt-3 text-sm text-slate-600">
                A tabela do CRECI orienta <strong>6% a 8% do valor do imóvel</strong> para venda e <strong>10% a 12% do valor total anual</strong> para locação. O percentual exato é negociado entre as partes e deve constar em contrato de exclusividade assinado.
              </p>
            </details>

            <details className="bg-white border border-slate-200 rounded-xl p-5 group">
              <summary className="font-semibold text-slate-900 cursor-pointer list-none flex justify-between items-center">
                Corretor autônomo pode usar recibo no lugar de nota fiscal?
                <span className="text-slate-400 group-open:rotate-180 transition-transform">&#9660;</span>
              </summary>
              <p className="mt-3 text-sm text-slate-600">
