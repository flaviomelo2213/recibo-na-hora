    ...
    <div className="min-h-screen bg-slate-50 pb-20">
      ...
      <div className="bg-stone-900 text-white py-16 px-4 text-center">
        ...
        <p className="text-stone-300 max-w-2xl mx-auto text-lg">
          ...
          <span className="block mt-2 text-amber-400 font-bold">100% Grátis e Ilimitado.</span>
        </p>
      </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {ferramentas.map((ferramenta, idx) => (
            <Link 
              ...
              className="bg-white p-8 rounded-2xl shadow-lg border border-stone-100 hover:shadow-2xl hover:-translate-y-1 transition-all group flex flex-col"
            >
              <div className={`w-16 h-16 bg-amber-100 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform`}>
                <i className={`fa-solid ${ferramenta.icone} text-3xl text-amber-600`}></i>
              </div>
              ...
              <span className="text-stone-800 font-bold text-sm flex items-center bg-amber-50 w-fit px-4 py-2 rounded-full group-hover:bg-stone-800 group-hover:text-amber-50 transition-all mt-auto">
