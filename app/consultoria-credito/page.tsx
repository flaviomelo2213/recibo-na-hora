      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-green-50 border border-green-200 rounded-lg p-6 mb-6">
          <h3 className="text-sm font-semibold text-green-900 mb-2">
            Sobre a estratégia de lance fixo
          </h3>
          <p className="text-sm text-green-800 leading-relaxed">
            A estratégia de lance fixo de 44 parcelas permite contemplação mais rápida em grupos de consórcio,
            utilizando um valor pré-calculado como lance. Esta simulação é baseada em dados do Grupo 012145 e
            serve como referência para planejamento financeiro.
          </p>
        </div>

        <button
          onClick={handleWhatsAppClick}
          className="w-full bg-green-600 hover:bg-green-700 text-white font-semibold py-4 px-6 rounded-lg transition-colors flex items-center justify-center gap-3 text-base"
        >
        ...
        <div className="mt-6 text-center">
          <p className="text-xs text-slate-500">
            Esta é uma simulação. Os valores finais podem variar conforme as condições do grupo e administradora.
          </p>
        </div>
      </div>
    </main>
