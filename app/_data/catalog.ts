...
export const TOOLS: ToolItem[] = [
  ...
  },
  {
    id: "recibo-simples",
    name: "Recibo Simples",
    description: "Modelo básico de recibo para qualquer tipo de pagamento.",
    categoryId: "recibos",
  ...
  },
  {
    ...
    description: "Contrato completo para locação de imóvel residencial.",
    categoryId: "contratos",
  ...
  {
    id: "procuracao-plenos-poderes",
    name: "Procuração de Plenos Poderes",
    description: "Procuração ampla para representação legal geral.",
    categoryId: "contratos",
  ...
  {
    id: "procuracao-inss",
    name: "Procuração para INSS",
    description: "Procuração específica para trâmites no INSS.",
    categoryId: "contratos",
  ...
  {
    id: "procuracao-bancaria",
    name: "Procuração Bancária",
    description: "Procuração para movimentação e transações bancárias.",
    categoryId: "contratos",
    href: "/ferramentas/procuracao-bancaria",
    badges: ["Novo", "Grátis"],
    iconKey: "fileSignature",
  },
  {
    id: "procuracao-imoveis",
    name: "Procuração para Imóveis e Inventário",
    description: "Procuração para transações imobiliárias e inventário.",
    categoryId: "contratos",
    href: "/ferramentas/procuracao-imoveis",
    badges: ["Novo", "Grátis"],
    iconKey: "fileSignature",
  },
  {
    ...
    description: "Procuração básica personalizável.",
    categoryId: "contratos",
  ...
  },
  {
    ...
    name: "Procuração Profissional",
    description: "Procuração com recursos avançados de personalização.",
    categoryId: "contratos",
    href: "/ferramentas/procuracao-profissional",
    badges: ["Grátis"],
    iconKey: "fileSignature",
  },
  {
